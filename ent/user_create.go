...
func (uc *UserCreate) SetAlarmURL(s string) *UserCreate {
	uc.mutation.SetAlarmURL(s)
	return uc
}

// SetNillableAlarmURL sets the "alarmURL" field if the given value is not nil.
func (uc *UserCreate) SetNillableAlarmURL(s *string) *UserCreate {
	if s != nil {
		uc.SetAlarmURL(*s)
	}
	return uc
