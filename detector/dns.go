...
// detect dns detect
func (srv *DNSSrv) detect(ctx context.Context, config *ent.DNSDetector) (dnsDetectorResult *ent.DNSDetectorResult, err error) {
...
func (srv *DNSSrv) Detect(ctx context.Context) (err error) {
	ctx, cancel := context.WithTimeout(ctx, defaultTimeout)
	defer cancel()
