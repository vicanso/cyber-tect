...
var (
	...
	ConfigurationsColumns = []*schema.Column{
		...
		{Name: "category", Type: field.TypeEnum, Enums: []string{"mockTime", "blockIP", "signedKey", "routerConcurrency", "router", "sessionInterceptor", "requestConcurrency", "email", "httpServerInterceptor"}},
	...
	DNSDetectorsColumns = []*schema.Column{
		...
		{Name: "owners", Type: field.TypeJSON},
		{Name: "receivers", Type: field.TypeJSON},
		{Name: "timeout", Type: field.TypeString},
		{Name: "interval", Type: field.TypeString, Nullable: true},
	...
	DNSDetectorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "dnsdetector_name",
				Unique:  true,
				Columns: []*schema.Column{DNSDetectorsColumns[4]},
			},
			{
				Name:    "dnsdetector_owners",
				Unique:  false,
	...
	DNSDetectorResultsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "dnsdetectorresult_max_duration",
				Unique:  false,
				Columns: []*schema.Column{DNSDetectorResultsColumns[5]},
			},
		},
	}
	// DatabaseDetectorsColumns holds the columns for the "database_detectors" table.
	DatabaseDetectorsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "status", Type: field.TypeInt8, Default: 1},
	...
	// DatabaseDetectorsTable holds the schema information for the "database_detectors" table.
	DatabaseDetectorsTable = &schema.Table{
		Name:       "database_detectors",
		Columns:    DatabaseDetectorsColumns,
		PrimaryKey: []*schema.Column{DatabaseDetectorsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "databasedetector_created_at",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorsColumns[1]},
			},
			{
				Name:    "databasedetector_updated_at",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorsColumns[2]},
			},
			{
				Name:    "databasedetector_name",
				Unique:  true,
				Columns: []*schema.Column{DatabaseDetectorsColumns[4]},
			},
			{
				Name:    "databasedetector_owners",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorsColumns[5]},
			},
		},
	}
	// DatabaseDetectorResultsColumns holds the columns for the "database_detector_results" table.
	DatabaseDetectorResultsColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "created_at", Type: field.TypeTime},
		{Name: "updated_at", Type: field.TypeTime},
		{Name: "task", Type: field.TypeInt},
	...
	// DatabaseDetectorResultsTable holds the schema information for the "database_detector_results" table.
	DatabaseDetectorResultsTable = &schema.Table{
		Name:       "database_detector_results",
		Columns:    DatabaseDetectorResultsColumns,
		PrimaryKey: []*schema.Column{DatabaseDetectorResultsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "databasedetectorresult_created_at",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorResultsColumns[1]},
			},
			{
				Name:    "databasedetectorresult_updated_at",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorResultsColumns[2]},
			},
			{
				Name:    "databasedetectorresult_task",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorResultsColumns[3]},
			},
			{
				Name:    "databasedetectorresult_result",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorResultsColumns[4]},
			},
			{
				Name:    "databasedetectorresult_max_duration",
				Unique:  false,
				Columns: []*schema.Column{DatabaseDetectorResultsColumns[5]},
			},
		},
	}
	...
	HTTPDetectorsColumns = []*schema.Column{
		...
		{Name: "proxies", Type: field.TypeJSON, Nullable: true},
		{Name: "random_query_string", Type: field.TypeInt8, Nullable: true},
	}
	...
	HTTPDetectorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "httpdetector_name",
				Unique:  true,
				Columns: []*schema.Column{HTTPDetectorsColumns[4]},
			},
			{
				Name:    "httpdetector_owners",
				Unique:  false,
	...
	HTTPDetectorResultsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "httpdetectorresult_max_duration",
				Unique:  false,
	...
	PingDetectorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "pingdetector_name",
				Unique:  true,
				Columns: []*schema.Column{PingDetectorsColumns[4]},
			},
			{
				Name:    "pingdetector_owners",
				Unique:  false,
	...
	PingDetectorResultsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "pingdetectorresult_max_duration",
				Unique:  false,
	...
	TCPDetectorsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "tcpdetector_name",
				Unique:  true,
				Columns: []*schema.Column{TCPDetectorsColumns[4]},
			},
			{
				Name:    "tcpdetector_owners",
				Unique:  false,
	...
	TCPDetectorResultsTable = &schema.Table{
		...
		Indexes: []*schema.Index{
			...
			{
				Name:    "tcpdetectorresult_max_duration",
				Unique:  false,
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "alarm_url", Type: field.TypeString, Nullable: true},
	}
	...
	Tables = []*schema.Table{
		...
		DatabaseDetectorsTable,
		DatabaseDetectorResultsTable,
		HTTPDetectorsTable,
