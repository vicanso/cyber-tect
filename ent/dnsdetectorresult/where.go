...
func Result(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
...
func ResultEQ(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldResult), v))
	})
}
...
func ResultNEQ(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
...
func ResultIn(vs ...int8) predicate.DNSDetectorResult {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ResultNotIn(vs ...int8) predicate.DNSDetectorResult {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func ResultGT(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
...
func ResultGTE(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
...
func ResultLT(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
...
func ResultLTE(v int8) predicate.DNSDetectorResult {
	return predicate.DNSDetectorResult(func(s *sql.Selector) {
