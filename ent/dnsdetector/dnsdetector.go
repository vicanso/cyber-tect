...
const (
	// Label holds the string label denoting the dnsdetector type in the database.
	Label = "dns_detector"
...
// Columns holds all SQL columns for dnsdetector fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
...
// OrderOption defines the ordering options for the DNSDetector queries.
