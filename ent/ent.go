...
func checkColumn(table, column string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			dnsdetector.Table:            dnsdetector.ValidColumn,
			dnsdetectorresult.Table:      dnsdetectorresult.ValidColumn,
			databasedetector.Table:       databasedetector.ValidColumn,
			databasedetectorresult.Table: databasedetectorresult.ValidColumn,
			httpdetector.Table:           httpdetector.ValidColumn,
			httpdetectorresult.Table:     httpdetectorresult.ValidColumn,
			pingdetector.Table:           pingdetector.ValidColumn,
			pingdetectorresult.Table:     pingdetectorresult.ValidColumn,
			tcpdetector.Table:            tcpdetector.ValidColumn,
			tcpdetectorresult.Table:      tcpdetectorresult.ValidColumn,
