...
func Status(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
...
func StatusEQ(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldStatus), vc))
	})
...
func StatusNEQ(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
...
func StatusIn(vs ...schema.Status) predicate.TCPDetectorResult {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StatusNotIn(vs ...schema.Status) predicate.TCPDetectorResult {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = int8(vs[i])
	}
...
func StatusGT(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
...
func StatusGTE(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
...
func StatusLT(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
...
func StatusLTE(v schema.Status) predicate.TCPDetectorResult {
	vc := int8(v)
	return predicate.TCPDetectorResult(func(s *sql.Selector) {
