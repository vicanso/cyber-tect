...
// Where adds a new predicate to the HTTPDetectorResultDelete builder.
func (hdrd *HTTPDetectorResultDelete) Where(ps ...predicate.HTTPDetectorResult) *HTTPDetectorResultDelete {
	hdrd.mutation.predicates = append(hdrd.mutation.predicates, ps...)
	return hdrd
}
...
func (hdrd *HTTPDetectorResultDelete) sqlExec(ctx context.Context) (int, error) {
	...
	return sqlgraph.DeleteNodes(ctx, hdrd.driver, _spec)
}
