...
// Where adds a new predicate to the TCPDetectorResultDelete builder.
func (tdrd *TCPDetectorResultDelete) Where(ps ...predicate.TCPDetectorResult) *TCPDetectorResultDelete {
	tdrd.mutation.predicates = append(tdrd.mutation.predicates, ps...)
	return tdrd
}
...
func (tdrd *TCPDetectorResultDelete) sqlExec(ctx context.Context) (int, error) {
	...
	return sqlgraph.DeleteNodes(ctx, tdrd.driver, _spec)
}
