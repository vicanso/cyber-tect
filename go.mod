...
require (
	...
	github.com/pyroscope-io/pyroscope v0.34.0
	...
	github.com/vicanso/elton-compress v1.3.3
	github.com/vicanso/elton-session v1.2.5
	github.com/vicanso/go-axios v1.4.3
	github.com/vicanso/go-cache/v2 v2.0.3
